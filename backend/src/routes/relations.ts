...
import { createRelationSchema, updateRelationSchema, detectRelationsSchema } from '../validators/relation.validator';
...
router.post('/detect', authenticate, authorize('ADMIN', 'EDITOR'), validate(detectRelationsSchema), relationsController.detectRelations);
